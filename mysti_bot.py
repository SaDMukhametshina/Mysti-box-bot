...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    print(f"🎯 Получена команда /start от пользователя {user.first_name} (ID: {user.id})")
        ...
        if IMAGE_URLS["promo"]:
            await update.message.reply_photo(
                ...
                caption="📢 <b>Текущие акции:</b>\n\n"
                        ...
                        "✔️ можно подарить на праздник или просто порадовать\n"
                        "✔️ универсально — понравится всем!\n\n"
...
# Запуск бота - адаптированный для Railway
async def main():
    ...
    print("🎴 Бот Mysti Box запущен на Railway! Для остановки проверь логи в панели управления.")
